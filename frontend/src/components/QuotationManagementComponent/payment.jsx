    ...
    <tbody className="bg-white">
      {data.map((item, index) => {
        ...
        return (
          ...
          >
            <td className="whitespace-nowrap pl-5  px-3 py-4 text-primary">
              S0001
            </td>{" "}
            <td className="whitespace-nowrap px-3 py-4 text-primary">Q1256</td>
            <td className="whitespace-nowrap px-3 py-4">Jane Smith</td>
            <td className="whitespace-nowrap px-3 py-4">Toyota camry</td>
            <td className="whitespace-nowrap px-3 py-4">$10,000</td>
            <td className="whitespace-nowrap px-3 py-4">$10,000</td>
            <td className="whitespace-nowrap px-3 py-4 text-secondary">
              Resolved
            </td>
...
export default function Payment() {
  const stats = [
    ...
    {
      title: "Partially Paid Quotations",
