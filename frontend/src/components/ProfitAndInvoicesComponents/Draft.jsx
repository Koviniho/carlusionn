...
import {
  invoicesInputs,
  profitInputs,
} from "../../Inputs/profit&invoices.input";
  ...
  return (
    <thead>
      <tr className="bg-primary !rounded-none">
        ...
        <th
          scope="col"
          className="py-3.5 pl-5 pr-3 text-left font-semibold text-white w-1/6"
        >
          Trans. ID
        </th>
        <th
      ...
      {data &&
        data.map((item) => (
          ...
          >
            ...
            <td className="whitespace-nowrap px-3 pl-5  text-lightBlackText w-1/6">
              {/* {item?.vehicleId || "-"} */}
              {item.id}
            </td>
            ...
            <td className="whitespace-nowrap px-3  w-1/6">
            ...
            <td className="whitespace-nowrap px-3 py-4  flex items-center gap-3">
              ...
              <FiDownload size={17} className="text-secondary" />
          ...
          <div className="flex items-center gap-5">
            ...
            >
              <form onSubmit={formik.handleSubmit}>
                <div className="grid grid-cols-1 gap-4 p-5 px-8 space-y-1">
