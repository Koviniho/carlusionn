...
const data = [
  {
    ...
    markeModell: "X5M Competition Steptronic Competition",
    ...
    <tbody className="bg-white">
      {data.map((item, index) => (
        ...
        >
          ...
          <td className="w-1/6 whitespace-nowrap px-3 py-4">
            {item.customerName}
          </td>
          <td className="w-1/6 whitespace-nowrap px-3 py-4">
            {item.markeModell}
          </td>
          <td className="w-1/6 whitespace-nowrap px-3 py-4 text-blue-500 flex items-center gap-2">
            {item.information}
            <span>
          ...
          <td
            className={`w-1/6 whitespace-nowrap px-3 py-4 ${
              item.status.includes("Tagen") ? "text-green-500" : "text-red-500"
            }`}
          >
            {item.status}
          </td>
