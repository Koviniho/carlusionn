    ...
    <div>
      <div>
        ...
        <p className="mb-4 text-lg text-grayText">
          Select the datasheet layout you want to use:
        </p>
        <div className=" text-darkBlue  text-sm   mb-4">
          <CustomSelect  options={layoutOptions}></CustomSelect>
        </div>
      </div>
      <div>
        <h2 className="text-2xl font-medium  text-darkBlue mb-4">
...
export default ContractLayoutEdit;
