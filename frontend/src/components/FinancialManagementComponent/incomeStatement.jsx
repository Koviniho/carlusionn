  ...
  const assetSections = [
    {
      ...
      items: [
        { label: "Vehicle Sales", value: "$200,78" },
        { label: "Service Revenue", value: "$200,78" },
      ],
    },
    {
      ...
      items: [
        { label: "Vehicle Costs", value: "$200,78" },
        { label: "Other COGS", value: "$200,78" },
      ],
    },
  ];
  ...
  const liabilitiesSections = [
    {
      ...
      items: [
        ...
        { label: "Marketing", value: "$200,78" },
        { label: "Office Expenses", value: "$200,78" },
      ],
    },
    {
      ...
      items: [
        { label: "Interest Income", value: "$200,78" },
        { label: "Interest Expense", value: "$200,78" },
      ],
    },
  ];
  return (
        ...
        <div className="py-10">
          <div className="bg-primary">
            <div className="grid grid-cols-1 px-10 py-2 md:grid-cols-2 gap-8">
              <p className="text-white font-medium">Income Statement</p>
            </div>
          </div>
          <div className="grid grid-cols-1 px-10 py-2 md:grid-cols-2 gap-8">
