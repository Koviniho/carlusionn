...
import AutoCenter from "../../components/GarageSettingComponent/AutoCenter/index";
import Modal from "../../components/modal/modal";
import CustomInput from "../../components/Input/custoInput";
import Button from "../../components/Button";

export default function GarageSettingPage() {
  const [selectedTab, setSelectedTab] = useState("Autocenter Niederbipp AG");

  // Tab names
  const tabs = ["Autocenter Niederbipp AG"];

  // Render the content for the selected tab
  const renderTabContent = () => {
    const tabContent = {
      "Autocenter Niederbipp AG": <AutoCenter />,
      // "Add Location": <></>,
    };
  ...
  return (
    <div>
      ...
      <MainHeading
        heading="Car Dealership Settings"
        textColor="darkBlue"
        ...
        <div className="p-4">
          ...
          <div className="flex gap-1">
           <input
            ...
            className="text-sm outline-none p-2 bg-[#F5F9FE]"
          />
